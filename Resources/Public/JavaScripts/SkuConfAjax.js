...
function txEcompcSetOption() {
	$('.ecom-configurator-select-package-option-wrap').on('click', function (e) {
		...
		genericAjaxRequest($(this).attr('data-t3pid'), $(this).attr('data-t3lang'), 1407764087, 'setOption', {
			...
			if ( result.showResult ) {
				...
				$('#ecom-configurator-result-canvas .ecom-configurator-result small.ecom-configurator-result-code').first().html(result.configurationData[2]);
...
function txEcompcIndex() {
	$('.ecom-configurator-package-select').on('click', function (e) {
		...
		if ( $(this).hasClass('ecom-configurator-package-state-0') || $(this).hasClass('current') )
			return false;
		addAjaxLoader('ecom-configurator-ajax-loader');
		genericAjaxRequest($(this).attr('data-t3pid'), $(this).attr('data-t3lang'), 1407764087, 'index', {
