...
$GLOBALS['TCA']['tt_content']['types']['list']['subtypes_addlist'][$pluginSignature] = 'tx_' . $extKey . '_type;;tx_ecompc, tx_' . $extKey . '_configurations, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.extended, bodytext;LLL:EXT:' . $extKey . '/Resources/Private/Language/locallang_db.xlf:bodytext_formlabel;;richtext:rte_transform[flag=rte_enabled|mode=ts_css], rte_enabled';
